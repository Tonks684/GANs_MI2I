...
for epoch in range(start_epoch, opt.niter + opt.niter_decay + 1):
    ...
    print('Average SSIM for Epoch {} Train = {}'.format(epoch,
                                                             avg_ssim_train))
    avg_psnr_train = np.mean(psnr_scores)
    print('Average PSNR for Epoch {} Train = {}'.format(epoch,
                                                           avg_psnr_train))
    ...
    print('Average SSIM for Epoch {} Val = {}'.format(epoch, avg_ssim_val))
    avg_psnr_val = np.mean(psnr_scores)
    print('Average PSNR for Epoch {} Val = {}'.format(epoch, avg_psnr_val))
