...
class BaseOptions():
    ...
    def initialize(self):    
        ...
        self.parser.add_argument('--name', type=str, default='dlmbl', help='name of the experiment. It decides where to store samples and models')        
        self.parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        self.parser.add_argument('--checkpoints_dir', type=str, default='./training/', help='models are saved here')
        self.parser.add_argument('--model', type=str, default='pix2pixHD', help='which model to use')
        self.parser.add_argument('--norm', type=str, default='instance', help='instance normalization or batch normalization')        
        self.parser.add_argument('--use_dropout', action='store_true', help='use dropout for the generator')
        self.parser.add_argument('--data_type', default=32, type=int, choices=[8, 16, 32,64], help="Supported data type i.e. 8, 16, 32 bit")
        self.parser.add_argument('--float', default=True, help="Is input float or integer")
        ...
        self.parser.add_argument('--input_RGB', default=False, help='# RGB?')
        self.parser.add_argument('--output_RGB', default=False, help='# RGB?')
        self.parser.add_argument('--seed', type=int, help='set seed for run')

        # for setting inputs
        self.parser.add_argument('--dataroot', type=str, default='./datasets/cityscapes/')
        self.parser.add_argument('--target', type=str, default ='nuclei', help='folder name containing target virtual stain for training') 
        ...
        self.parser.add_argument('--no_flip', default=True,action='store_true', help='if specified, do not flip the images for data argumentation') 
        ...
        self.parser.add_argument("--dropout_variation_inf",
                                 choices=[True,False] ,default=False,type=bool,
        ...
        self.parser.add_argument("--output_reshape", type=int, default=512,
