...
from data.data_loader_gskbroad import CreateDataLoader
...
#         )
    ...
    # Prediction
    final_pred_path = os.path.join(save_path, img_name) #.split('_')[3], img_name[:-4] + "_virtualstain.tiff")
    imsave(final_pred_path, visuals['synthesized_image'].astype(np.uint16))
