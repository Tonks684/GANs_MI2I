...
## Log of changes made to repository
1. 16bit modifications to train.py and test.py and related functions (details in ./changelog/16bit_pix2pixHD_mods)
2. Improved train.py to compare SSIM and PSNR on train and validation set (details in ./changelog/Training_improvements.md)
3. Update to test_16bit.py to work with any image shape. (details in ./changelog/Test_Prediction_reshape.md)
4. Confidence Map creation (details in ./changelog/Variation_inference.md) 
