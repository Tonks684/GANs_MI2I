...
if __name__ == "__main__":
    ...
    for a549_hoechst_folder in tqdm(range(1,29)):
        train_dataset_url = \
        f"https://public.czbiohub.org/comp.micro/viscy/VSCyto2D/training/a549_hoechstgit add _cellmask_train_val.zarr/0/0/{a549_hoechst_folder}/0"
        try:
            ...
            for img in tqdm(range(dataset_np.shape[2])):
                ...
                for i, crop in enumerate(input_crops):
                    ...
                    imsave(output_path, crop.astype(np.float64),imagej=True)
